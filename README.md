...
- **HTML** - Mikaela, Chris, and Laura  
- **Backend Java** - Daniela and Temo
...
## **Integrating Banking Information and Advanced Budgeting Features:**  
1. **Banking API Integration (Plaid/Yodlee/Finicity)**  
   - Secure integration with third-party financial services to access user bank data.  
   - OAuth2 for secure user authentication.  
   - Compliance with PCI-DSS for financial data security.  

2. **User Budget and Spending Tracking:**  
   - Categorize transactions into user-defined budget categories.  
   - Provide insights into spending trends through graphs and charts.  

3. **Recurring Payments:**  
   - Users can define recurring payments (loans, subscriptions, etc.).  
   - Notifications about upcoming payments or deviations from the budget.  
...
## **Relevant NIST Publications for Security:**  
- [Data Security Framework](https://csrc.nist.gov/pubs/sp/800/171/r2/upd1/final)  
- [Secure Authentication Guidelines](https://pages.nist.gov/800-63-3/)  
- [Zero Trust Architecture](https://csrc.nist.gov/pubs/sp/800/207/final)  
- [Secure Deletion for Financial Information](https://csrc.nist.gov/pubs/sp/800/88/r1/final)
