...
Update Log
Updated on 4.27.25 by Temo Galindo - Added 7th test for Complete instance variable and functionality
...
public class milestone_driver {
    ...
    public static void main(String[] args) {
        ...
        milestone1.addAmountPaid(2000.00);
        System.out.printf("Name: %s\nTotal Amount: $%.2f\nAmount Paid: $%.2f\nBalance: $%.2f\n", milestone1.getName(), milestone1.getAmount(), milestone1.getAmountPaid(), milestone1.getBalance());
        ...
        System.out.println("Test 7 - Testing Complete Status ");
        System.out.printf("Name: %s\nTotal Amount: $%.2f\nAmount Paid: $%.2f\nStatus: %b\n", milestone1.getName(), milestone1.getAmount(), milestone1.getAmountPaid(), milestone1.isComplete());
        milestone1.addContribution();
        milestone1.addContribution();
        milestone1.addContribution();
        milestone1.addContribution();
        System.out.printf("Name: %s\nTotal Amount: $%.2f\nAmount Paid: $%.2f\nStatus: %b\n", milestone1.getName(), milestone1.getAmount(), milestone1.getAmountPaid(), milestone1.isComplete());
        milestone1.setAmountPaid(0.0);
        System.out.printf("Name: %s\nTotal Amount: $%.2f\nAmount Paid: $%.2f\nStatus: %b\n", milestone1.getName(), milestone1.getAmount(), milestone1.getAmountPaid(), milestone1.isComplete());
        milestone1.setAmountPaid(4500.00);
        System.out.printf("Name: %s\nTotal Amount: $%.2f\nAmount Paid: $%.2f\nStatus: %b\n", milestone1.getName(), milestone1.getAmount(), milestone1.getAmountPaid(), milestone1.isComplete());
